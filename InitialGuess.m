classdef InitialGuess
  ...
  methods
    function ig = InitialGuess(step, draw)
      ig.xb = [-step/2,step/4,step/4+step/8,step/2];
      ig.yb = [sqrt(0.8^2-(step/2)^2),sqrt(0.8^2-(step/4)^2),sqrt(0.8^2-(step/4)^2)*1.1,sqrt(0.8^2-(step/2)^2)];
      ig.thb = [pi/4,pi/4,pi/4,pi/4];
      ig.lw = [0,0,0,0];
      ig.th1 = [asin(step/2/0.8),-asin(step/4/0.8),-asin(step/4/0.8),-asin(step/2/0.8)]+(pi+pi/4);
      ig.th2 = [0,0,0,0];
      ig.th3 = [acos(step/2/0.8),pi-acos(step/4/0.8),pi-acos(step/4/0.8),pi-acos(step/2/0.8)];
      ig.th4 = [-asin(step/2/0.8),asin(step/4/0.8),asin(step/4/0.8),asin(step/2/0.8)]+(pi+pi/4);
